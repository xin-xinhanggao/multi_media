...
featurelist = ["242", "484", "224", "422"]
distancelist = ["L2", "HI", "Bh", "ch"]
...
if __name__ == "__main__":
	if len(sys.argv) == 5:
		...
		if sys.argv[1] in featurelist and sys.argv[2] in distancelist and sys.argv[3] == "sa":
			query("QueryImages.txt", "AllImages.txt", sys.argv[1], sys.argv[2], True)
		else:
			print "Parameters error!"
			print "Histogram choice", featurelist
			print "Ditance choice", distancelist

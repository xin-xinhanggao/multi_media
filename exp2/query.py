...
from distance import L2, HI, Bh
import os
import numpy

def query(filename1, filename2, fchoice, dchoice):
    queryname, querydata, queryfeature = extract(filename1, fchoice)
    imgname, imgdata, imgfeature = extract(filename2, fchoice)
    correct = 0
    total = 0
